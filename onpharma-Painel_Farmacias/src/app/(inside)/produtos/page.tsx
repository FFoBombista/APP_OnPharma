...
import { ProducEditDialog } from '@/components/ProductEditDialog';
        ...
        <>
            <Box sx={{my: 3, displayPrint: 'none'}}> 
                ...
                <Dialog open={showDeleteDialog} onClose={() => !loadingDelete ? setShowDeleteDialog(false) : null}>
                    ...
                    <DialogContent>
                        <DialogContentText>
                            Não é possível voltar atras após confirmar esta ação 
                        </DialogContentText>
                        <DialogActions>
